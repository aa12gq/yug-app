...
import '../descriptor.pb.dart' as $5;
...
class CodeGeneratorRequest extends $pb.GeneratedMessage {
  factory CodeGeneratorRequest({
    ...
    $core.Iterable<$5.FileDescriptorProto>? protoFile,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CodeGeneratorRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.protobuf.compiler'), createEmptyInstance: create)
    ...
    ..pc<$5.FileDescriptorProto>(15, _omitFieldNames ? '' : 'protoFile', $pb.PbFieldType.PM, subBuilder: $5.FileDescriptorProto.create)
  ;
  ...
  ///  fully qualified.
  @$pb.TagNumber(15)
  $core.List<$5.FileDescriptorProto> get protoFile => $_getList(3);
}
...
class CodeGeneratorResponse_File extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CodeGeneratorResponse.File', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.protobuf.compiler'), createEmptyInstance: create)
    ...
    ..aOM<$5.GeneratedCodeInfo>(16, _omitFieldNames ? '' : 'generatedCodeInfo', subBuilder: $5.GeneratedCodeInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(16)
  $5.GeneratedCodeInfo get generatedCodeInfo => $_getN(3);
  @$pb.TagNumber(16)
  set generatedCodeInfo($5.GeneratedCodeInfo v) { setField(16, v); }
  @$pb.TagNumber(16)
  $core.bool hasGeneratedCodeInfo() => $_has(3);
  @$pb.TagNumber(16)
  void clearGeneratedCodeInfo() => clearField(16);
  @$pb.TagNumber(16)
  $5.GeneratedCodeInfo ensureGeneratedCodeInfo() => $_ensure(3);
}
