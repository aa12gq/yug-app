...
class HttpBody extends $pb.GeneratedMessage {
  factory HttpBody({
    ...
    $core.Iterable<$2.Any>? extensions,
  }) {
    final $result = create();
    if (contentType != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HttpBody', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api'), createEmptyInstance: create)
    ...
    ..pc<$2.Any>(3, _omitFieldNames ? '' : 'extensions', $pb.PbFieldType.PM, subBuilder: $2.Any.create)
  ...
  /// for streaming APIs.
  @$pb.TagNumber(3)
  $core.List<$2.Any> get extensions => $_getList(2);
}
