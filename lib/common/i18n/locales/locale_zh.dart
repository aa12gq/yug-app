...
Map<String, String> localeZh = {
  ...
  LocaleKeys.settingsAccountSecurityDesc: '管理您的账号安全设置',
  LocaleKeys.settingsPrivacyDesc: '管理您的隐私设置',
  ...
  LocaleKeys.settingsClearCacheConfirm: '确定要清除缓存吗？当前大小：',
  LocaleKeys.settingsClearCacheSuccess: '缓存已清除',
  LocaleKeys.settingsClearCacheFailed: '清除缓存失败',
  LocaleKeys.settingsLogout: '退出登录',
  LocaleKeys.settingsLogoutTitle: '退出登录',
  LocaleKeys.settingsLogoutConfirm: '确定要退出登录吗？',
  LocaleKeys.settingsLogoutFailed: '退出登录失败',
  LocaleKeys.settingsPersonalization: '个性化设置',
  LocaleKeys.settingsActivityHelp: '活动与帮助',
